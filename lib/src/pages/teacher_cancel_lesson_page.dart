...
class TeacherCancelLessonPage extends StatefulWidget {
  ...
  const TeacherCancelLessonPage({
    super.key,
    required this.payload,
  });

  @override
  State<TeacherCancelLessonPage> createState() =>
      _TeacherCancelLessonPageState();
}

class _TeacherCancelLessonPageState extends State<TeacherCancelLessonPage> {
  ...
  Future<void> _cancelLesson() async {
    ...
    try {
      ...
      if (_reasonController.text.trim().isNotEmpty) {
        updateData["cancelReason"] = _reasonController.text.trim();
      }
